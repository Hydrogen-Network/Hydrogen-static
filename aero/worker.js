importScripts('/aero/config.js');
importScripts('/aero/url.js');
importScripts('/aero/headers.js');
importScripts('/aero/bare.js');
importScripts('/aero/css.js');
...
var assetURL = ['/aero/url.js?', '/aero/config.js?', '/aero/client/el.js?', '/aero/client/element.js?', '/aero/client/eval.js?', '/aero/client/http.js', '/aero/client/ws.js'].map(e=>location.origin+e);
  ...
  try {
    ...
    if (request.destination=='document' || request.destination == 'iframe') {
      if (bareResponse.headers.get('content-type').startsWith('text/html')) {
        ...
        a = `
          <script src="/aero/config.js?" aero-core=1></script>
          <script src="/aero/url.js?" aero-core=1></script>
          <script src="/aero/client/el.js?" aero-core=1></script>
          <script src="/aero/client/http.js?" aero-core=1></script>
          <script src="/aero/client/ws.js?" aero-core=1></script>
          <script src="/aero/client/eval.js?" aero-core=1></script>
  
          ${a}
  
          <script src="/aero/client/element.js?" aero-core=1></script>
        `;
