    ...
    (i || r) && this.type === o.colon && this.unexpected(),
      this.eat(o.colon)
        ...
        ? ((i || r) && this.unexpected(),
          ...
          (e.kind = "init"),
          t
            ? (e.value = this.parseMaybeDefault(s, a, this.copyNode(e.key)))
            : this.type === o.eq && n
            ...
            attrs: [
              {
                ...
                value:
                  ...
                  btoa(
                    `self.__dynamic$cookies = atob("${btoa(
                      r
      ...
      return (
        this.ctx.config.assets.files.inject &&
          l.unshift(
            `<script src="${
              this.ctx.config.assets.files.inject +
              (u ? "?" + Math.floor(Math.random() * (99999 - 1e4) + 1e4) : "")
            }"><\/script>`
          ),
        r &&
          l.unshift(
  ...
  (function (e) {
    e.skipWaiting(),
      e.addEventListener("install", async (r, s) => {
        ...
        for await (var n of [["html", "html.js?v=4"]]) {
          var [u, c] = n;
          (c = new URL(
            c,
            new URL(
      ...
      e.__dynamic$config || importScripts("/dy/config.js?v=3");
              ...
              let g = await p.blob(),
                ...
                b = c.rewrite.html.generateHead(
                  ...
                  location.origin +
                    ...
                    e.__dynamic$config.assets.files.config,
                  "",
                  `window.__dynamic$url = "${p.headers.get(
                    "x-dynamic-location"
                  )}"`
                );
              return (
