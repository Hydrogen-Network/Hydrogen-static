...
document.addEventListener("DOMContentLoaded", function(event) { 
  ...
  if (selectedValue === 'Google') {
      icon.setAttribute('href', '/static/img/cloaksgoogle.png');
      name.textContent = 'Google';
      localStorage.setItem("name", "Google");
      localStorage.setItem("icon", "/static/img/cloaksgoogle.png");
  } 
  else if (selectedValue === 'Drive') {
      icon.setAttribute('href', '/static/img/cloaksdrive.png');
      name.textContent = 'My Drive - Google Drive';
      localStorage.setItem("name", "My Drive - Google Drive");
      localStorage.setItem("icon", "/static/img/cloaksdrive.png");
  } 
  else if (selectedValue === 'Classroom') {
      icon.setAttribute('href', '/static/img/cloaksclassroom.png');
      name.textContent = 'Classes';
      localStorage.setItem("name", "Classes");
      localStorage.setItem("icon", "/static/img/cloaksclassroom.png");
  }
  else if (selectedValue === 'Schoology') {
      icon.setAttribute('href', '/static/img/cloaksschoology.png');
      name.textContent = 'Home | Schoology';
      localStorage.setItem("name", "Home | Schoology");
      localStorage.setItem("icon", "/static/img/cloaksschoology.png");
  }
  else if (selectedValue === 'Gmail') {
      icon.setAttribute('href', '/static/img/cloaksgmail.png');
      name.textContent = 'Gmail';
      localStorage.setItem("name", "Gmail");
      localStorage.setItem("icon", "/static/img/cloaksgmail.png");
  }
  else if (selectedValue === 'Clever') {
      icon.setAttribute('href', '/static/img/cloaksclever.png');
      name.textContent = 'Clever | Portal';
      localStorage.setItem("name", "Clever | Portal");
      localStorage.setItem("icon", "/static/img/cloaksclever.png");
  }
  else if (selectedValue === 'Khan') {
      icon.setAttribute('href', '/static/img/cloakskhan.png');
