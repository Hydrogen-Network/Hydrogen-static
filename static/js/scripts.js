...
script("Injected script 1/6 (Google Tag Manager)");
...
script("Injected script 2/6 (Ad stuff)");
...
script("Injected script 3/6(Ad stuff)");
...
script("Injected script 4/6(Ad stuff)");
...
script("Injected script 5/6(Ad stuff)");
